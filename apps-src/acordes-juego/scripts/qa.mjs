...
const samples = load("src/audio/samples.ts");
const failures = [];
...
check(samples.pickRandomTrackIndex(15, -1, () => 0) === 0, "Inicio aleatorio mínimo incorrecto");
check(samples.pickRandomTrackIndex(15, -1, () => 0.999) === 14, "Inicio aleatorio máximo incorrecto");
check(samples.pickRandomTrackIndex(15, 7, () => 0) === 0, "Salto aleatorio inferior incorrecto");
check(samples.pickRandomTrackIndex(15, 7, () => 0.999) === 14, "Salto aleatorio superior incorrecto");
check(samples.pickRandomTrackIndex(15, 0, () => 0) === 1, "La música no debe repetirse inmediatamente");
