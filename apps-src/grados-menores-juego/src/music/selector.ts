...
// Carpeta para sonidos de apoyo (radiofaro/cadencia/llegada): si el timbre es Aleatorio
 ...
 *
 * Un grado cuya clase escrita no está en el inventario simplemente no aparece: es lo que
 * pasa con el IVly de A#m (se escribe E## y no hay archivo ni fallback). Comportamiento
 * heredado de la webapp seria — el menú avisa (PLAN §3.2), aquí no se "arregla".
 */
