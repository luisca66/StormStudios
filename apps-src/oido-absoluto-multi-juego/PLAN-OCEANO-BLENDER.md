...
| 4 | Portal atlante (compuerta) | `portal/` | ⏳ brief listo (2026-09-16), esperando a Astra | `(110,-50,110)`, radio de disparo 5 u, abre en 0.7 s; cinemática a 15 u; partes `frame` + `iris_leaf` ×6 + `glow` |
