...
| Cangrejos y calamares de primitivas | `spawnCrab`, `spawnSquid` | **Astra** → piezas 7–8 |
...
(coherente con Glub, el cocodrilo y el unicornio del juego). Propuesta: renovar modelos **y**
...
| 8 | Fauna media (sustituye calamares) | por decidir | ❓ Luis | opciones: tortugas marinas ×3, cardumen instanciado, o reusar el Calamar Vela de Batisfera |
