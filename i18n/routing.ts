...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    "/apps": "/apps",
    "/maestro-virtual": { es: "/maestro-virtual", en: "/virtual-teacher" },
    "/apps/acordes/jugar": {
    ...
    "/apps/acordes-cantar/juego": {
      es: "/apps/acordes-cantar/juego",
      en: "/apps/acordes-cantar/game",
    },
    ...
    "/apps/oido-absoluto-guitarra/juego": {
      es: "/apps/oido-absoluto-guitarra/juego",
      en: "/apps/oido-absoluto-guitarra/game",
    },
