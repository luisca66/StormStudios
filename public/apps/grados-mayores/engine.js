// engine.js — Lógica pura (sin DOM) portada de MusicTheory.kt / StatsStore.kt.
import {
...
// (cobertura completa) antes de repetir ninguno, y nunca repite el mismo grado dos
// veces seguidas — tampoco al pasar de un ciclo al siguiente. Dentro de cada grado
// varía la octava (y el timbre en modo Aleatorio).
...
const STATS_KEY = "GradosMayoresStats";
